...
export default function Home({ isPremium }: HomeProps) {
  ...
  return (
    <div className="min-h-screen bg-[linear-gradient(to_bottom,#F2DFC0_0%,#FDF3E3_320px,#FDF3E3_100%)] dark:bg-black">
      ...
      <div
        ...
        style={isPremium ? { paddingBottom: isAndroid ? '150px' : '80px' } : undefined}
      >
      ...
      <div
        ...
        style={{ bottom: (isPremium ? isAndroid : Capacitor.getPlatform() === 'android') ? '150px' : '90px' }}
      >
        <HelpMenu />
      </div>
