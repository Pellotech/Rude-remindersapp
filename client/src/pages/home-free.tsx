  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <div className="container mx-auto px-4 py-8 max-w-7xl">
        ...
        {/* Stats Dashboard - identical layout to premium */}
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          <Card className="border-blue-200 bg-gradient-to-br from-blue-50 to-cyan-50 dark:from-blue-950 dark:to-cyan-950">
            ...
            <CardContent>
              <div className="text-2xl font-bold text-blue-600">{freeUsage.reminders}</div>
              <p className="text-xs text-gray-500">{freeUsage.reminders}/{FREE_LIMITS.reminders} used</p>
            </CardContent>
          </Card>
          ...
          <Card className="border-purple-200 bg-gradient-to-br from-purple-50 to-pink-50 dark:from-purple-950 dark:to-pink-950">
            ...
            <CardContent>
              <div className="text-2xl font-bold text-purple-600">{freeUsage.voiceCharacters}</div>
              <p className="text-xs text-gray-500">{FREE_LIMITS.voiceCharacters} available</p>
            </CardContent>
          </Card>
          ...
          <Card className="border-orange-200 bg-gradient-to-br from-orange-50 to-yellow-50 dark:from-orange-950 dark:to-yellow-950">
            ...
            <CardContent>
              <div className="text-2xl font-bold text-orange-600">Standard</div>
              <p className="text-xs text-gray-500">Good quality responses</p>
            </CardContent>
          </Card>
        </div>

        {/* Feature Showcase - identical layout to premium */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          <Card className="border-blue-200">
            ...
            <CardContent>
              <p className="text-sm text-gray-600 dark:text-gray-300">
                Add visual context with {FREE_LIMITS.attachments} photo per reminder
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="border-purple-200">
            ...
            <CardContent>
              <p className="text-sm text-gray-600 dark:text-gray-300">
                Choose from {FREE_LIMITS.voiceCharacters} unique voice personalities
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="border-green-200">
            ...
            <CardContent>
              <p className="text-sm text-gray-600 dark:text-gray-300">
                Track your progress with essential completion metrics
              </p>
            </CardContent>
          </Card>
        </div>
