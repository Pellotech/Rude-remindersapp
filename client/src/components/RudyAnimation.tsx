...
export default function RudyAnimation({ animationIndex, onComplete }: RudyAnimationProps) {
  ...
  useEffect(() => {
    ...
    // Safety net — fires only if animation logic stalls
    ...
    if (animationIndex === 0) {
      ...
      schedule(() => go("translateX(0px)", "transform 250ms ease-in-out"), 850);
      ...
      schedule(() => go("translate(0px, 0px) scale(1)", "transform 250ms ease-in-out"), 850);
      schedule(() => { setSrc(IMGS.thumbsUp); setTransition("none"); }, 1100);
      ...
      schedule(() => go("translate(4px, 0px)", "transform 250ms ease-in-out"), 700);
      schedule(() => go("translate(0px, 0px)", "transform 250ms ease-in-out"), 950);
      schedule(() => go("translate(160px, 0px)", "transform 800ms ease-in, opacity 800ms ease-in", 0), 1200);
      ...
      schedule(() => { setSrc(IMGS.angry); setTransition("none"); }, 500);
      schedule(() => {
